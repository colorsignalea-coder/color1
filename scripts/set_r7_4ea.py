# coding: utf-8
"""
set_r7_4ea.py — R7 EA 자동 선택 + Gen + Run [TEST 1콤보]
...
사용법:
  python set_r7_4ea.py          # 현재 R7 EA만 선택 후 Gen+Run
  python set_r7_4ea.py all       # 모든 EA 체크 ON (Gen+Run 안 함)
  python set_r7_4ea.py none      # 모든 EA 체크 OFF
"""
import sys, time
