# coding: utf-8
"""
set_r8_4ea.py — R8 EA 자동 선택 + Gen + Run [TEST 1콤보]
#   AITRP1 8fc → AI_TRIPLE_3_1_GoldBTC_0323_8fc
#   BRaid2 8fc → BRaid_SAR_3_2_GoldBTC_0323_8fc
#   TRange 8fc → BTC_Gold_TrendRange_EA_0323_8fc
#   LRC0 8fc → LRC_EA_3_0_GoldBTC_0323_8fc
사용법:
  python set_r8_4ea.py          # 현재 R8 EA만 선택 후 Gen+Run
  python set_r8_4ea.py all       # 모든 EA 체크 ON (Gen+Run 안 함)
  python set_r8_4ea.py none      # 모든 EA 체크 OFF
"""
import sys, time
...
ALL_EA_LABELS = set(['AITRP1 3fc', 'AITRP1 4fc', 'AITRP1 5fc', 'AITRP1 6fc', 'AITRP1 7fc', 'AITRP1 8fc', 'AI_TRIPLE', 'AI_TRIPLE 2fc', 'BRaid2 3fc', 'BRaid2 4fc', 'BRaid2 5fc', 'BRaid2 6fc', 'BRaid2 7fc', 'BRaid2 8fc', 'BRaid_SAR', 'BRaid_SAR 2fc', 'B_DFT2', 'B_FB5', 'COLOR175', 'COLORBB B', 'COLORBB G', 'FB5_2Sma', 'LRC0 3fc', 'LRC0 4fc', 'LRC0 5fc', 'LRC0 6fc', 'LRC0 7fc', 'LRC0 8fc', 'LRC_EA', 'LRC_EA 2fc', 'SupplyDem', 'SupplyDemand 2fc', 'Survivor 2fc', 'Survivor v2', 'TRange 3fc', 'TRange 4fc', 'TRange 5fc', 'TRange 6fc', 'TRange 7fc', 'TRange 8fc', 'TrendRange', 'TrendRange 2fc', 'euraka'])
R_EA_KEEP     = set(['AITRP1 8fc'])
...
for hwnd,text in ea_h:
    ...
    set_check(hwnd,want)
    print(f"  {'[R8] ' if want else '       '}{text}: {'ON ✅' if want else 'off'}")
...
print(f"\nDONE: R8 백테스트 시작! (1EA x 1SL x 1TP = 1콤보 [TEST])")
