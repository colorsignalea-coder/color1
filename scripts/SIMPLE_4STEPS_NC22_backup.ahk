...
; =====================================================
; 4단계 백테스트 자동화 NC (No-Keyboard/Mouse) nc2.2
; base: SIMPLE_4STEPS_NC21.ahk (nc2.1) → nc2.2 개선판
; - nc2.2: SOLO_9_87 스타일 HTML 자동닫기 이식 (신규/닫음/분석 카운터)
...
logFile := A_WorkingDir "\scripts\simple_4steps_nc22_log.txt"
