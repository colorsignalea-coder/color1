# coding: utf-8
"""
set_r4_3ea.py — R4 EA 자동 선택 + Gen + Run [TEST 1콤보]
#   BRaid2 4fc → BRaid_SAR_3_2_GoldBTC_0323_4fc
#   TRange 4fc → BTC_Gold_TrendRange_EA_0323_4fc
#   LRC0 4fc → LRC_EA_3_0_GoldBTC_0323_4fc
사용법:
  python set_r4_3ea.py          # 현재 R4 EA만 선택 후 Gen+Run
  python set_r4_3ea.py all       # 모든 EA 체크 ON (Gen+Run 안 함)
  python set_r4_3ea.py none      # 모든 EA 체크 OFF
"""
import sys, time
...
ALL_EA_LABELS = set(['AI_TRIPLE', 'AI_TRIPLE 2fc', 'BRaid2 3fc', 'BRaid2 4fc', 'BRaid_SAR', 'BRaid_SAR 2fc', 'B_DFT2', 'B_FB5', 'COLOR175', 'COLORBB B', 'COLORBB G', 'FB5_2Sma', 'LRC0 3fc', 'LRC0 4fc', 'LRC_EA', 'LRC_EA 2fc', 'SupplyDem', 'SupplyDemand 2fc', 'Survivor 2fc', 'Survivor v2', 'TRange 3fc', 'TRange 4fc', 'TrendRange', 'TrendRange 2fc', 'euraka'])
...
print(f"\nDONE: R4 백테스트 시작! (1EA x 1SL x 1TP = 1콤보 [TEST])")
