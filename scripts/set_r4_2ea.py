# coding: utf-8
"""set_r4_2ea.py — R4 EA 자동 선택 + Gen + Run [TEST 1콤보]
#   BRaid2 4fc → BRaid_SAR_3_2_GoldBTC_0323_4fc
#   TRange 4fc → BTC_Gold_TrendRange_EA_0323_4fc"""
import sys, time
...
ALL_EA_LABELS = set(['AI_TRIPLE', 'AI_TRIPLE 2fc', 'BRaid2 3fc', 'BRaid2 4fc', 'BRaid_SAR', 'BRaid_SAR 2fc', 'B_DFT2', 'B_FB5', 'COLOR175', 'COLORBB B', 'COLORBB G', 'FB5_2Sma', 'LRC_EA', 'LRC_EA 2fc', 'SupplyDem', 'SupplyDemand 2fc', 'Survivor 2fc', 'Survivor v2', 'TRange 3fc', 'TRange 4fc', 'TrendRange', 'TrendRange 2fc', 'euraka'])
R_EA_KEEP     = set(['BRaid2 4fc'])
...
for hwnd,text in ea_h:
    ...
    set_check(hwnd,want)
    print(f"  {'[R4] ' if want else '       '}{text}: {'ON ✅' if want else 'off'}")
...
print(f"\nDONE: R4 시작! (1EA x 1SL x 1TP = 1콤보 [TEST])")
